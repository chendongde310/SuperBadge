...
public class StringSerializable {
   ...
   private  static  final  String FILENAME= "SuperBadgeDater";
     ...
     * modified:
     */
     static void saveSuperBadgeHelper(Context context, String key , SuperBadgeHelper obj){
        try {
            // 保存对象
     ...
     * modified:
     */
    static SuperBadgeHelper readSuperBadgeHelper(Context context,String key ){
        try {
            ...
            if (sharedata.contains(key)) {
                ...
                if(TextUtils.isEmpty(string)){
                    ...
                    //返回反序列化得到的对象
                    SuperBadgeHelper readSuperBadgeHelper = (SuperBadgeHelper) is.readObject();
                    return readSuperBadgeHelper;
                }
            }
